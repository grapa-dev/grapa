...
export class GrapaLanguageProvider implements 
    ...
    provideSignatureHelp(
        ...
        const signatures = [
            new vscode.SignatureInformation(
                'echo()',
                new vscode.MarkdownString('Print the string to console')
            ),
            new vscode.SignatureInformation(
                'len()',
                new vscode.MarkdownString('Get the length of the string')
            ),
            new vscode.SignatureInformation(
                'get(index)',
                new vscode.MarkdownString('Get element at specified index')
            ),
            new vscode.SignatureInformation(
                'set(index, value)',
                new vscode.MarkdownString('Set element at specified index')
            ),
            new vscode.SignatureInformation(
                'sign(data, digest?, padding?)',
                new vscode.MarkdownString('Sign data with private key. Optional digest and padding parameters.')
            ),
            new vscode.SignatureInformation(
                'verify(signature, data, digest?, padding?)',
                new vscode.MarkdownString('Verify signature with public key. Optional digest and padding parameters.')
            )
        ];
