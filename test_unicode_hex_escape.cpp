...
int main() {
    std::cout << "Unicode Hex Escape Test" << std::endl;
    std::cout << "=======================" << std::endl;

    // Use hex escape sequences instead of Unicode escapes
    std::string input_nfc = "café\n";  // NFC form
    std::string input_nfd = "cafe\xCC\x81\n";  // NFD form (e + combining acute) - hex escape
