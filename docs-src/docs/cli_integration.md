...
**Universal Installer:**
- **All Platforms:** `install-grapa-0.1.56.py` - Automatically detects platform and downloads appropriate package
...
2. Extract the archive and navigate to the directory: `cd grapa-0.1.56`
