...
g++ -c -Isource source/mainlib.cpp source/grapa/*.cpp source/openssl-lib/ubuntu64/*.a source/fl-lib/ubuntu64/*.a source/blst-lib/ubuntu64/*.a -Lsource/openssl-lib/ubuntu64 -lcrypto -lXfixes -lXft -lXext -lXrender -lXinerama -lfontconfig -lXcursor -ldl -lm -static-libgcc -lX11 -O3 -pthread
...
g++ -shared -Isource source/mainlib.cpp source/grapa/*.cpp source/openssl-lib/ubuntu64/*.a source/fl-lib/ubuntu64/*.a source/blst-lib/ubuntu64/*.a -Lsource/openssl-lib/ubuntu64 -lcrypto -lXfixes -lXft -lXext -lXrender -lXinerama -lfontconfig -lXcursor -ldl -lm -static-libgcc -lX11 -O3 -pthread -fPIC -o grapa.so
