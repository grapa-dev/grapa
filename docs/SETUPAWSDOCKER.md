...
docker run --platform=linux/arm64 -it --name amazonlinux-apple amazonlinux:2023 uname -m
docker run --platform=linux/amd64 -it --name amazonlinux-intel amazonlinux:2023 uname -m
