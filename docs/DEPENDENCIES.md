...
mkdir build_static
cd build_static
cmake -G "NMake Makefiles" -DPCRE2_BUILD_PCRE2_8=ON -DPCRE2_BUILD_PCRE2_16=ON -DPCRE2_BUILD_PCRE2_32=ON -DBUILD_SHARED_LIBS=OFF -DPCRE2_STATIC_RUNTIME=ON -DPCRE2_SUPPORT_UNICODE=ON -DPCRE2_SUPPORT_UNICODE_PROPERTIES=ON -DPCRE2_SUPPORT_UNICODE_BLOCKS=ON -DCMAKE_BUILD_TYPE=Release ..
nmake
```
