...
int main() {
    ...
    auto matches = grep_unicode(input, pattern, "i", "", ProcessingMode::UNICODE_MODE, NormalizationForm::NFC); // case-insensitive
    ...
    auto matches_nfc = grep_unicode(test_text, test_pattern, "", "", ProcessingMode::UNICODE_MODE, NormalizationForm::NFC);
    std::cout << "Matches with NFC: " << matches_nfc.size() << "\n";
    
    // Test with NFD normalization
    auto matches_nfd = grep_unicode(test_text, test_pattern, "", "", ProcessingMode::UNICODE_MODE, NormalizationForm::NFD);
    std::cout << "Matches with NFD: " << matches_nfd.size() << "\n";
    
    // Test with NFKC normalization
    auto matches_nfkc = grep_unicode(test_text, test_pattern, "", "", ProcessingMode::UNICODE_MODE, NormalizationForm::NFKC);
