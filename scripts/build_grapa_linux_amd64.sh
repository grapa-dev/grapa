...
# Build Grapa Application and Libraries for Linux AMD64
# This script builds the Grapa executable, static library, and shared library
# Assumes third-party libraries are already available in source/*/linux-amd64/

set -e

echo "🐳 Building Grapa for Linux AMD64..."
...
docker run -it --rm \
    ...
    grapa-build \
    bash -c "
        echo '🚀 Starting Grapa build for Linux AMD64...'
        ...
        echo '📋 Built files:'
        ls -la grapa
        ls -la source/grapa-lib/linux-amd64/libgrapa.a
        ls -la source/grapa-other/linux-amd64/libgrapa.so
        ls -la bin/grapa-linux-amd64.tar.gz
    "

echo "✅ Docker build completed successfully!"
echo "📁 Application is available as grapa"
echo "📁 Static library is available in source/grapa-lib/linux-amd64/"
echo "📁 Shared library is available in source/grapa-other/linux-amd64/"
echo "📁 Compressed file is available in bin/grapa-linux-amd64.tar.gz" 