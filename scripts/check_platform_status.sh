...
echo "   Linux ARM64:   ./scripts/build_grapa_linux_arm64.sh"
echo "   Linux AMD64:   ./scripts/build_grapa_linux_amd64.sh"
echo "   macOS ARM64:   python3 build.py --bin-only"
echo "   macOS AMD64:   ./scripts/build_grapa_macos_amd64.sh (requires ARM64 Mac)"
echo "   Windows AMD64: ./scripts/build_grapa_windows_amd64.sh (requires Windows)"
echo ""
echo "🌐 Build all available: ./scripts/build_all_platforms.sh" 