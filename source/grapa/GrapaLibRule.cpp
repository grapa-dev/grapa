...
bool IsStringNumeric(GrapaCHAR& str, GrapaScriptExec* vScriptExec)
{
	...
	testInt.FromString(str, 10);
	
	// If integer parsing worked, it's numeric
	if (testInt != originalInt)
	{
		return true;
	}
	
	// Try to parse as float and convert back to string - if they match, it's a valid float
	GrapaFloat testFloat(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, 0);
	GrapaBYTE strBytes;
	strBytes.FROM(str);
	testFloat.FromString(strBytes, 10);
	
	// Convert float back to string and compare
	GrapaCHAR floatStr = testFloat.ToString();
...
static int DoComparison(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	// Handle LIST, LIST, VECTOR, and XML comparisons
	if (r1.vVal && r2.vVal && r1.vVal->vQueue && r2.vVal->vQueue)
	{
		// LIST comparisons (ordered elements)
		if (r1.vVal->mValue.mToken == GrapaTokenType::LIST && r2.vVal->mValue.mToken == GrapaTokenType::LIST)
		{
		...
		else if (r1.vVal->mValue.mToken == GrapaTokenType::GOBJ && r2.vVal->mValue.mToken == GrapaTokenType::GOBJ)
		{
			GrapaRuleQueue* q1 = (GrapaRuleQueue*)r1.vVal->vQueue;
			GrapaRuleQueue* q2 = (GrapaRuleQueue*)r2.vVal->vQueue;
...
class GrapaLibraryRuleVectorTransposeEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorTransposeEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorTranspose(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorTransposeEvent(pName); }

class GrapaLibraryRuleVectorRrefEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorRrefEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorRref(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorRrefEvent(pName); }

class GrapaLibraryRuleVectorInvEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorInvEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorInv(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorInvEvent(pName); }

class GrapaLibraryRuleVectorDetEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorDetEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorDet(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorDetEvent(pName); }

class GrapaLibraryRuleVectorRankEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorRankEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorRank(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorRankEvent(pName); }

class GrapaLibraryRuleVectorSolveEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorSolveEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorSolve(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorSolveEvent(pName); }

class GrapaLibraryRuleVectorCovEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorCovEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorCov(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorCovEvent(pName); }

class GrapaLibraryRuleVectorSumEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorSumEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorSum(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorSumEvent(pName); }

class GrapaLibraryRuleVectorMeanEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorMeanEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorMean(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorMeanEvent(pName); }

class GrapaLibraryRuleVectorMinEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorMinEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorMin(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorMinEvent(pName); }

class GrapaLibraryRuleVectorMaxEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorMaxEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorMax(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorMaxEvent(pName); }

class GrapaLibraryRuleVectorStdEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorStdEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorStd(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorStdEvent(pName); }

class GrapaLibraryRuleVectorVarEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorVarEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorVar(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorVarEvent(pName); }

class GrapaLibraryRuleVectorShapeEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorShapeEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorShape(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorShapeEvent(pName); }

class GrapaLibraryRuleVectorReShapeEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorReShapeEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorReShape(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorReShapeEvent(pName); }

class GrapaLibraryRuleVectorDotEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorDotEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorDot(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorDotEvent(pName); }

class GrapaLibraryRuleVectorTriUEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorTriUEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorTriU(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorTriUEvent(pName); }

class GrapaLibraryRuleVectorTriLEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorTriLEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorTriL(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorTriLEvent(pName); }

class GrapaLibraryRuleVectorEigHEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorEigHEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorEigH(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorEigHEvent(pName); }

class GrapaLibraryRuleVectorIdentityEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorIdentityEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorIdentity(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorIdentityEvent(pName); }

class GrapaLibraryRuleVectorDiagEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorDiagEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorDiag(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorDiagEvent(pName); }

class GrapaLibraryRuleVectorNormEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorNormEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorNorm(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorNormEvent(pName); }

class GrapaLibraryRuleVectorModeEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorModeEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorMode(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorModeEvent(pName); }

class GrapaLibraryRuleVectorMedianEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorMedianEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorMedian(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorMedianEvent(pName); }

class GrapaLibraryRuleVectorPercentileEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorPercentileEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorPercentile(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorPercentileEvent(pName); }

class GrapaLibraryRuleVectorQuantileEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorQuantileEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorQuantile(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorQuantileEvent(pName); }

class GrapaLibraryRuleVectorSkewEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorSkewEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleVectorSkew(GrapaCHAR& pName) { return new GrapaLibraryRuleVectorSkewEvent(pName); }

class GrapaLibraryRuleVectorKurtosisEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleVectorKurtosisEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
...
class GrapaLibraryRuleGenHashSetEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleGenHashSetEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleGenHashSet(GrapaCHAR& pName) { return new GrapaLibraryRuleGenHashSetEvent(pName); }

class GrapaLibraryRuleGenHashEvent : public GrapaLibraryEvent
{
public:
	GrapaLibraryRuleGenHashEvent(GrapaCHAR& pName) { mName.FROM(pName); };
	virtual GrapaRuleEvent* Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput);
};
GrapaLibraryEvent* GrapaLibraryRuleEvent::HandleGenHash(GrapaCHAR& pName) { return new GrapaLibraryRuleGenHashEvent(pName); }
...
GrapaLibraryEvent* GrapaLibraryRuleEvent::LoadLib(GrapaScriptExec *vScriptExec, GrapaRuleEvent *pOperation, GrapaCHAR& pName)
{
	...
	if (mName.mLength==0 || mName.Cmp("$SYS") == 0)
	{
		static const std::unordered_map<std::string, Handler> handlerMap = {
			...
			{ "genhashset", &GrapaLibraryRuleEvent::HandleGenHashSet },
			{ "genhash", &GrapaLibraryRuleEvent::HandleGenHash },
	...
	{
		static const std::unordered_map<std::string, Handler> handlerMap = {
			{ "pwd", &GrapaLibraryRuleEvent::HandlePwd },
			{ "cd", &GrapaLibraryRuleEvent::HandleCd },
			{ "phd", &GrapaLibraryRuleEvent::HandlePhd },
			{ "chd", &GrapaLibraryRuleEvent::HandleChd },
			{ "ls", &GrapaLibraryRuleEvent::HandleLs },
			{ "mk", &GrapaLibraryRuleEvent::HandleMk },
			{ "rm", &GrapaLibraryRuleEvent::HandleRm },
			{ "mkfield", &GrapaLibraryRuleEvent::HandleMkField },
			{ "rmfield", &GrapaLibraryRuleEvent::HandleRmField },
			{ "info", &GrapaLibraryRuleEvent::HandleInfo },
			{ "getfield", &GrapaLibraryRuleEvent::HandleFileGet },
			{ "setfield", &GrapaLibraryRuleEvent::HandleFileSet },
			{ "split", &GrapaLibraryRuleEvent::HandleFileSplit },
			{ "dump", &GrapaLibraryRuleEvent::HandleDump },
		};
		auto it = handlerMap.find((char*)pName.mBytes);
		if (it != handlerMap.end())
			return (this->*(it->second))(pName);
	...
	else if (mName.Cmp("$thread") == 0)
	{
		static const std::unordered_map<std::string, Handler> handlerMap = {
			{ "trylock", &GrapaLibraryRuleEvent::HandleTryLock },
			{ "lock", &GrapaLibraryRuleEvent::HandleLock },
			{ "unlock", &GrapaLibraryRuleEvent::HandleUnLock },
			{ "wait", &GrapaLibraryRuleEvent::HandleWait },
			{ "thread_signal", &GrapaLibraryRuleEvent::HandleSignal },
			{ "waiting", &GrapaLibraryRuleEvent::HandleWaiting },
			{ "start", &GrapaLibraryRuleEvent::HandleStart },
			{ "stop", &GrapaLibraryRuleEvent::HandleStop },
			{ "started", &GrapaLibraryRuleEvent::HandleStarted },
			{ "suspend", &GrapaLibraryRuleEvent::HandleSuspend },
			{ "resume", &GrapaLibraryRuleEvent::HandleResume },
			{ "suspended", &GrapaLibraryRuleEvent::HandleSuspended },
		};
		auto it = handlerMap.find((char*)pName.mBytes);
		if (it != handlerMap.end())
			return (this->*(it->second))(pName);
	...
	{
		static const std::unordered_map<std::string, Handler> handlerMap = {
			{ "mac", &GrapaLibraryRuleEvent::HandleMac },
			{ "interfaces", &GrapaLibraryRuleEvent::HandleInterfaces },
			{ "connect", &GrapaLibraryRuleEvent::HandleConnect },
			{ "bind", &GrapaLibraryRuleEvent::HandleBind },
			{ "listen", &GrapaLibraryRuleEvent::HandleListen },
			{ "onlisten", &GrapaLibraryRuleEvent::HandleOnListen },
			{ "disconnect", &GrapaLibraryRuleEvent::HandleDisconnect },
			{ "proxy", &GrapaLibraryRuleEvent::HandleProxy },
			{ "certificate", &GrapaLibraryRuleEvent::HandleCertificate },
			{ "private", &GrapaLibraryRuleEvent::HandlePrivate },
			{ "trusted", &GrapaLibraryRuleEvent::HandleTrusted },
			{ "verify", &GrapaLibraryRuleEvent::HandleNetVerify },
			{ "chain", &GrapaLibraryRuleEvent::HandleNetChain },
			{ "host", &GrapaLibraryRuleEvent::HandleNetHost },
			{ "send", &GrapaLibraryRuleEvent::HandleSend },
			{ "receive", &GrapaLibraryRuleEvent::HandleReceive },
			{ "pending", &GrapaLibraryRuleEvent::HandlePending },
			{ "onreceive", &GrapaLibraryRuleEvent::HandleOnReceive },
			{ "httpread", &GrapaLibraryRuleEvent::HandleHttpRead },
			{ "httpsend", &GrapaLibraryRuleEvent::HandleHttpSend },
			{ "httpmessage", &GrapaLibraryRuleEvent::HandleHttpMessage },
		};
		auto it = handlerMap.find((char*)pName.mBytes);
		if (it != handlerMap.end())
			return (this->*(it->second))(pName);
	...
	else if (mName.Cmp("$WIDGET") == 0)
	{
		static const std::unordered_map<std::string, Handler> handlerMap = {
			{ "new", &GrapaLibraryRuleEvent::HandleWidgetNew },
			{ "show", &GrapaLibraryRuleEvent::HandleWidgetShow },
			{ "hide", &GrapaLibraryRuleEvent::HandleWidgetHide },
			{ "redraw", &GrapaLibraryRuleEvent::HandleWidgetRedraw },
			{ "resizable", &GrapaLibraryRuleEvent::HandleWidgetResizable },
			{ "resize", &GrapaLibraryRuleEvent::HandleWidgetResize },
			{ "parent", &GrapaLibraryRuleEvent::HandleWidgetParent },
			{ "child", &GrapaLibraryRuleEvent::HandleWidgetChild },
			{ "next", &GrapaLibraryRuleEvent::HandleWidgetNext },
			{ "focus", &GrapaLibraryRuleEvent::HandleWidgetFocus },
			{ "get", &GrapaLibraryRuleEvent::HandleWidgetGet },
			{ "set", &GrapaLibraryRuleEvent::HandleWidgetSet },
			{ "handle", &GrapaLibraryRuleEvent::HandleWidgetHandle },
			{ "callback", &GrapaLibraryRuleEvent::HandleWidgetCallback },
			{ "event_key", &GrapaLibraryRuleEvent::HandleWidgetEventKey },
	...
	if (lib == NULL)
	{
        ...
        if (lib == NULL)
        {
			...
			else if (pName.Cmp("gobj") == 0) lib = new GrapaLibraryRuleListEvent(pName);
			else if (pName.Cmp("list") == 0) lib = new GrapaLibraryRuleArrayEvent(pName);
...
GrapaRuleEvent* GrapaLibraryRuleGetEnvEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal)
	{
		...
		else if (r1.vVal->mValue.Cmp("$GRAPA_VERSION") == 0 || (r1.vVal->mValue.mToken == GrapaTokenType::SYSID && r1.vVal->mValue.Cmp("GRAPA_VERSION") == 0))
		{
			err = 0;
			result = new GrapaRuleEvent(0, GrapaCHAR("version"), gSystem->mVersion);
		}
		else if (r1.vVal->mValue.Cmp("$LICENSE") == 0 || (r1.vVal->mValue.mToken == GrapaTokenType::SYSID && r1.vVal->mValue.Cmp("LICENSE") == 0)
			|| r1.vVal->mValue.Cmp("$LICENCE") == 0 || (r1.vVal->mValue.mToken == GrapaTokenType::SYSID && r1.vVal->mValue.Cmp("LICENCE") == 0))
		{
			err = 0;
			if (gSystem->mStaticLib && gSystem->mStaticLib->mCount)
			{
				GrapaRuleEvent* ev = gSystem->mStaticLib->Search("LICENSE",idx);
				if (ev)
				{
...
GrapaRuleEvent* GrapaLibraryRulePutEnvEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal)
	{
		if (r1.vVal->mValue.Cmp("$GRAPA_PATH") == 0 || (r1.vVal->mValue.mToken == GrapaTokenType::SYSID && r1.vVal->mValue.Cmp("GRAPA_PATH") == 0))
		{
			if (r2.vVal && (r2.vVal->mValue.mToken == GrapaTokenType::LIST || r2.vVal->mValue.mToken == GrapaTokenType::TUPLE || r2.vVal->mValue.mToken == GrapaTokenType::GOBJ))
			{
				err = 0;
				if (gSystem->mPath)
				{
...
GrapaRuleEvent* GrapaLibraryRuleEvalEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (cmdstr.vVal && (cmdstr.vVal->mValue.mToken == GrapaTokenType::STR || cmdstr.vVal->mValue.mToken == GrapaTokenType::RAW))
	{
		if (GrapaRuleEvent* operation = vScriptExec->vScriptState->AddRuleOperation(pNameSpace->GetNameQueue(), "", ""))
		{
			...
			if (e && e->mValue.mToken == GrapaTokenType::GOBJ && e->vQueue)
			{
				while (e->vQueue->Head())
				...
				//if (option->vQueue)
				{
					...
					if (actions && actions->vQueue)
					{
						...
						case 2:
							...
							if (v && v->mValue.mToken != GrapaTokenType::GOBJ && !v->mNull)
							{
...
GrapaRuleEvent* GrapaLibraryRuleGrammarEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	while (token)
	{
		if (token->mName.mLength && token->mValue.mToken == GrapaTokenType::TOKEN)
		{
			...
			//case GrapaTokenType::GOBJ: result->mValue.GrapaCHAR::Append("$GOBJ "); break;
...
GrapaRuleEvent* GrapaLibraryRuleGetNameEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	else if (r1.vVal && r1.vVal->vQueue && (r1.vVal->mValue.mToken == GrapaTokenType::GOBJ|| r1.vVal->mValue.mToken == GrapaTokenType::TAG))
	{
		GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
		s64 index = 0;
...
static GrapaRuleEvent* ItemAssignRun(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput, const GrapaCHAR& pName, GrapaError& err)
{
	...
	if (r1.vVal)
	{
		...
		u8 isFlowChange = r?r->mControlFlow:0;
		GrapaBYTE isName;
				...
				if (GrapaMem::StrCmp((char*)pName.mBytes, pName.mLength, "assignappend") == 0 || GrapaMem::StrCmp((char*)pName.mBytes, pName.mLength, "assignextend") == 0 || GrapaMem::StrCmp((char*)pName.mBytes, pName.mLength, "assignmul") == 0 || GrapaMem::StrCmp((char*)pName.mBytes, pName.mLength, "assigndiv") == 0 || GrapaMem::StrCmp((char*)pName.mBytes, pName.mLength, "assignmod") == 0 || GrapaMem::StrCmp((char*)pName.mBytes, pName.mLength, "assignpow") == 0)
				{
					...
					if (parameter->mValue.mToken == GrapaTokenType::TAG)
					{
						...
						if (parameter->vQueue->mCount == 0)
						{
							...
							ev->mValue.mToken = GrapaTokenType::GOBJ;
					...
					if (parameter->mValue.mToken == GrapaTokenType::CLASS)
					{
						...
						if (parameter->vQueue == NULL)
						{
							...
							parameter->mValue.mToken = GrapaTokenType::GOBJ;
						}
					}
...
GrapaRuleEvent* GrapaLibraryRuleCreateListEvent::Optimize(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleEvent* pParam)
{
	if (pParam && pParam->vQueue && pParam->vQueue->mCount)
	{
		...
		{
			v = (GrapaRuleEvent*)pOperation->vQueue->PopTail();
			v->mValue.mToken = GrapaTokenType::GOBJ;
			pOperation->CLEAR();
			delete pOperation;
			pOperation = v;
		}
...
GrapaRuleEvent* GrapaLibraryRulePrependEvent::Optimize(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleEvent* pParam)
{
	...
	{
		GrapaRuleEvent *v = (GrapaRuleEvent*)pParam->vQueue->Head();
		if ((v->mValue.mToken == GrapaTokenType::LIST || v->mValue.mToken == GrapaTokenType::TUPLE || v->mValue.mToken == GrapaTokenType::GOBJ || v->mValue.mToken == GrapaTokenType::ERR || v->mValue.mToken == GrapaTokenType::XML || v->mValue.mToken == GrapaTokenType::EL || v->mValue.mToken == GrapaTokenType::TAG || v->mValue.mToken == GrapaTokenType::OBJ) && v->vQueue)
		{
			bool noLambda = true;
			while (v)
			{
...
GrapaRuleEvent* GrapaLibraryRuleSearchEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (item)
	{
		...
		case GrapaTokenType::MODEL:
			if (item->vClass == NULL)
				item->vClass = vScriptExec->vScriptState->GetClass(pNameSpace, GrapaCHAR("$MODEL"));
			c = item->vClass;
			q = c ? &emptyQueue : NULL;
			root = item;
			break;
			...
			while (q && attrList) //a={"one"(1)=11,"two"(2)=22,"three"(3)=33}
			{
				...
				else if (attr->mValue.mToken == GrapaTokenType::STR || attr->mValue.mToken == GrapaTokenType::ID || attr->mValue.mToken == GrapaTokenType::SYSSTR || attr->mValue.mToken == GrapaTokenType::SYSID)
				{
					...
					*/
					...
					else if (e && (item->mValue.mToken == GrapaTokenType::LIST || item->mValue.mToken == GrapaTokenType::TUPLE))
					{
					...
					if (e == NULL)
					{
						if (attrList->Next() == NULL && root->mValue.mToken != GrapaTokenType::ERR && (root->mValue.mToken == GrapaTokenType::OBJ || root->mValue.mToken == GrapaTokenType::GOBJ || root->mValue.mToken == GrapaTokenType::TAG))
						{
				...
				if (e)
				{
					...
					case GrapaTokenType::MODEL:
						if (item2->vClass == NULL)
							item2->vClass = vScriptExec->vScriptState->GetClass(pNameSpace, GrapaCHAR("$MODEL"));
						c = item2->vClass;
						q = c ? &emptyQueue : NULL;
						root = item2;
						break;
					case GrapaTokenType::GOBJ:
						q = (GrapaRuleQueue*)item2->vQueue;
						if (item2->vClass == NULL)
							item2->vClass = vScriptExec->vScriptState->GetClass(pNameSpace, GrapaCHAR("$GOBJ"));
						c = item2->vClass;
						root = item2;
						break;
					case GrapaTokenType::XML:
...
bool MatchTAG(GrapaScriptExec* vScriptExec, GrapaRuleEvent* b, GrapaRuleEvent* p, bool all=false)
{
	...
	if (n == false)
	{
		...
		{
			if (pattr->mValue.mToken == GrapaTokenType::GOBJ)
			{
				n = false;
			...
			else if (pattr->mValue.mToken == GrapaTokenType::LIST || pattr->mValue.mToken == GrapaTokenType::TUPLE)
			{
				bool n3 = false;
	...
	if (n == false)
	{
		...
		if (has && has->vQueue && has->vQueue->mCount)
		{
			...
			{
				n = true;
				if (has->mValue.mToken == GrapaTokenType::GOBJ)
				{
...
bool MatchLIST(GrapaScriptExec* vScriptExec, GrapaRuleEvent* b,  GrapaRuleEvent* p, bool all=false)
{
	...
	if (n == false && b->mValue.mToken == GrapaTokenType::GOBJ && b->vQueue)
	{
		index = 0;
		GrapaRuleEvent* pattr = p->vQueue->Search(GrapaCHAR("attr"), index);
		if (pattr && pattr->vQueue && pattr->vQueue->mCount)
...
GrapaRuleEvent* FindAll(GrapaScriptExec* vScriptExec, GrapaRuleEvent* b, GrapaRuleEvent* p)
{
	...
	if ((b && b->vQueue) && (p && p->vQueue))
	{
		if (b->mValue.mToken == GrapaTokenType::XML)
			...
			a = new GrapaRuleEvent(GrapaTokenType::XML, 0, "", "");
		else if (b->mValue.mToken == GrapaTokenType::GOBJ)
			a = new GrapaRuleEvent(GrapaTokenType::GOBJ, 0, "", "");
		...
		else if (b->mValue.mToken == GrapaTokenType::GOBJ)
		{
			...
			if (n == true)
			{
				...
				while (jm)
				{
					if (jm->mValue.mToken == GrapaTokenType::GOBJ || jm->mValue.mToken == GrapaTokenType::ERR || jm->mValue.mToken == GrapaTokenType::LIST || jm->mValue.mToken == GrapaTokenType::TUPLE || jm->mValue.mToken == GrapaTokenType::XML || jm->mValue.mToken == GrapaTokenType::TAG)
					{
						...
						if (e && e->vQueue && e->vQueue->mCount)
						{
							while (e->vQueue->Head())
							{
								...
								if ((a->mValue.mToken == GrapaTokenType::LIST || a->mValue.mToken == GrapaTokenType::TUPLE || a->mValue.mToken == GrapaTokenType::ERR) && ep->mValue.mToken == GrapaTokenType::GOBJ)
									a->mValue.mToken = GrapaTokenType::GOBJ;
		...
		else if (b->mValue.mToken == GrapaTokenType::LIST || b->mValue.mToken == GrapaTokenType::TUPLE)
		{
			GrapaRuleEvent* jm = b->vQueue->Head();
			while (jm)
			{
				if (jm->mValue.mToken == GrapaTokenType::GOBJ || jm->mValue.mToken == GrapaTokenType::ERR || jm->mValue.mToken == GrapaTokenType::LIST || jm->mValue.mToken == GrapaTokenType::TUPLE || jm->mValue.mToken == GrapaTokenType::XML || jm->mValue.mToken == GrapaTokenType::TAG)
				{
					...
					if (n == false)
					{
						if ((a->mValue.mToken == GrapaTokenType::LIST || a->mValue.mToken == GrapaTokenType::TUPLE || a->mValue.mToken == GrapaTokenType::ERR) && b->mValue.mToken == GrapaTokenType::GOBJ)
							a->mValue.mToken = GrapaTokenType::GOBJ;
...
GrapaRuleEvent* GrapaLibraryRuleFindEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal && r2.vVal)
	{
		...
		// Special case: LIST input with LIST term - extract values and use array search logic
		else if (r1.vVal->mValue.mToken == GrapaTokenType::GOBJ && r2.vVal->mValue.mToken == GrapaTokenType::LIST)
		{
			// Get start position (default to 0)
			u64 start_pos = 0;
			if (r3.vVal && r3.vVal->mValue.mToken == GrapaTokenType::INT)
		...
		else if ((r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::GOBJ) &&
			(r2.vVal->mValue.mToken == GrapaTokenType::LIST || r2.vVal->mValue.mToken == GrapaTokenType::GOBJ))
		{
			// Get start position (default to 0)
			u64 start_pos = 0;
			if (r3.vVal && r3.vVal->mValue.mToken == GrapaTokenType::INT)
...
GrapaRuleEvent* GrapaLibraryRuleSortEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (rorder.vVal)
	{
		...
		else if (rorder.vVal && (rorder.vVal->mValue.mToken == GrapaTokenType::LIST || rorder.vVal->mValue.mToken == GrapaTokenType::TUPLE))
		{
	...
	if (rx && axis==0)
	{
		...
		case GrapaTokenType::OBJ:
			...
			else if (rx->vQueue)
			{
				...
				else if (result->mValue.mToken == GrapaTokenType::LIST || result->mValue.mToken == GrapaTokenType::TUPLE || result->mValue.mToken == GrapaTokenType::XML)
	...
	if (rx && axis == 0)
	{
		...
		case GrapaTokenType::OBJ:
			if (rx->vQueue)
			{
				...
				if (rkind.vVal && rkind.vVal->mValue.mToken == GrapaTokenType::OP)
					qsort(rq, i / 3, sizeof(GrapaRuleEvent*) * 3, GrapaLibraryItemSortEventCompareOP);
				else if (rx->mValue.mToken == GrapaTokenType::LIST || rx->mValue.mToken == GrapaTokenType::TUPLE || rx->mValue.mToken == GrapaTokenType::XML)
					qsort(rq, i / 3, sizeof(GrapaRuleEvent*) * 3, GrapaLibraryItemSortEventCompareValue);
				else
					qsort(rq, i / 3, sizeof(GrapaRuleEvent*) * 3, GrapaLibraryItemSortEventCompareName);
	...
	if (rx)
	{
		...
		case GrapaTokenType::OBJ:
			if (rx->vQueue)
			{
				...
				if (result->mValue.mToken == GrapaTokenType::GOBJ || result->mValue.mToken == GrapaTokenType::OBJ || result->mValue.mToken == GrapaTokenType::ERR)
				{
				...
				{
					// Original logic for other types (LIST, TUPLE, XML, etc.)
					GrapaRuleEvent* last = NULL;
					while (i)
					{
						i -= 3;
		...
		case GrapaTokenType::OBJ:
			if (rx->vQueue)
			{
				...
				if (r3.vVal && r3.vVal->mValue.mToken == GrapaTokenType::OP)
					result->mValue.mToken = GrapaTokenType::GOBJ;
				else if (result->mValue.mToken == GrapaTokenType::LIST || result->mValue.mToken == GrapaTokenType::XML)
					result->mValue.mToken = GrapaTokenType::LIST;
				...
				while (i)
				{
					...
					else
					{
						...
						key->mValue.mToken = GrapaTokenType::LIST;
						...
						last = (GrapaRuleEvent*)rq[i];
						rq[i] = NULL;
						if (result->mValue.mToken == GrapaTokenType::GOBJ)
						{
...
GrapaRuleEvent* GrapaLibraryRulePlanEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (script && (script->mValue.mToken == GrapaTokenType::LIST || script->mValue.mToken == GrapaTokenType::TUPLE || script->mValue.mToken == GrapaTokenType::GOBJ) && script->vQueue && script->vQueue->mCount)
	{ 
	...
	if (codeResult && codeResult->mControlFlow)
	{
		if (codeResult->mValue.mToken == GrapaTokenType::ERR)
			result = codeResult;
		else if ((codeResult->mValue.mToken == GrapaTokenType::LIST || codeResult->mValue.mToken == GrapaTokenType::TUPLE) && codeResult->vQueue && codeResult->vQueue->mCount && codeResult->vQueue->Tail()->mValue.mToken == GrapaTokenType::ERR)
		{
...
GrapaRuleEvent* GrapaLibraryRuleMapEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	{
		delList = new GrapaRuleEvent(GrapaTokenType::LIST, 0, "", "");
		...
		else
		{
			...
			{
				GrapaRuleEvent* t = new GrapaRuleEvent(GrapaTokenType::LIST, 0, "", "");
	...
	while (p)
	{
		...
		{
			nextItem = new GrapaRuleEvent(GrapaTokenType::GOBJ, 0, "");
	...
	bool hasThrow = false;
	GrapaRuleEvent* retPtr = new GrapaRuleEvent();
	retPtr->mValue.mToken = GrapaTokenType::GOBJ;
	retPtr->vQueue = new GrapaRuleQueue();
	retPtr->mControlFlow = GrapaControlFlowType::THROW;
			...
			if (we->mResult)
			{
				if (delList)
				{
					while (we->mResult->vQueue->Head())
					{
						...
						GrapaRuleEvent* rp = new GrapaRuleEvent();
						rp->SetNull();
						retPtr->vQueue->PushTail(rp);
						if (ev && ev->mControlFlow == GrapaControlFlowType::THROW)
						{
							hasThrow = true;
							rp->vRulePointer = ev;
							rp->mValue.mToken = GrapaTokenType::PTR;
						}
				...
				else
				{
					...
					rp->SetNull();
					retPtr->vQueue->PushTail(rp);
					if (we && we->mResult->mControlFlow == GrapaControlFlowType::THROW)
					{
						hasThrow = true;
						rp->vRulePointer = we->mResult;
						rp->mValue.mToken = GrapaTokenType::PTR;
					}
	...
	if (hasThrow)
	{
		GrapaRuleEvent* rp = retPtr->vQueue->Head();
		while (rp)
		{
			if (rp->vRulePointer)
			{
			...
			if (we->mResult)
			{
				if (delList)
				{
					...
					while (qq && first)
					{
						...
						if (qq && qq->mControlFlow == GrapaControlFlowType::THROW)
						{
							hasThrow = true;
							retPtr->vQueue->PushTail(we->mResult);
							we->mResult = NULL;
						}
						else
						{
...
//			if (toList->mValue.mToken == GrapaTokenType::LIST ||toList->mValue.mToken == GrapaTokenType::TUPLE || toList->mValue.mToken == GrapaTokenType::GOBJ || toList->mValue.mToken == GrapaTokenType::EL || toList->mValue.mToken == GrapaTokenType::TAG || toList->mValue.mToken == GrapaTokenType::OP)
...
GrapaRuleEvent* GrapaLibraryRuleFileSetEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (objEvent->mValue.mToken == GrapaTokenType::GOBJ || objEvent->mValue.mToken == GrapaTokenType::LIST || (objEvent->mValue.mToken == GrapaTokenType::OBJ && objEvent->vClass->mName.mLength && objEvent->vClass->mName.mBytes[0] != '$'))
	{
		s64 index;
		GrapaRuleEvent* r = NULL;
		...
		if (r2.vVal && r2.vVal->mValue.mBytes)
		{
			...
			else
			{
				...
				if (fieldValue.vVal)
				{
					...
					else if (fieldValue.vVal->mValue.mToken == GrapaTokenType::VECTOR)
					{
	...
	if ((objEvent->mValue.mToken == GrapaTokenType::OBJ && objEvent->vClass->mName.Cmp("$VECTOR") == 0) || objEvent->mValue.mToken == GrapaTokenType::VECTOR)
	{
		if (objEvent->vVector == NULL)
			objEvent->vVector = new GrapaVector();
	...
	if ((objEvent->mValue.mToken == GrapaTokenType::OBJ && objEvent->vClass->mName.Cmp("$file") == 0) || objEvent->mValue.mToken == GrapaTokenType::TABLE)
	{
		if (r2.vVal && r2.vVal->mValue.mBytes)
		{
			...
			if (fieldName.vVal && fieldName.vVal->mValue.mToken == GrapaTokenType::LIST)
			{
				...
				if (result && result->vQueue)
				{
					GrapaRuleEvent* scan = result->vQueue->Head();
					while (scan)
					{
						if (scan->mValue.mToken == GrapaTokenType::LIST || scan->mValue.mToken == GrapaTokenType::TUPLE || scan->mValue.mToken == GrapaTokenType::GOBJ || scan->mValue.mToken == GrapaTokenType::ERR || scan->mValue.mToken == GrapaTokenType::XML || scan->mValue.mToken == GrapaTokenType::EL || scan->mValue.mToken == GrapaTokenType::TAG || scan->mValue.mToken == GrapaTokenType::OP || scan->mValue.mToken == GrapaTokenType::CODE || scan->mValue.mToken == GrapaTokenType::ERR)
						{
							scan->vQueue = new GrapaRuleQueue();
							scan->vClass = ((GrapaRuleQueue*)scan->vQueue)->FROM(vScriptExec->vScriptState, pNameSpace, scan->mValue);
							if (scan->mValue.mLength == 0)
								scan->mNull = true;
							scan->mValue.SetLength(0);
							scan->mValue.SetSize(0);
						}
						else if (scan->mValue.mToken == GrapaTokenType::VECTOR)
						{
							if (scan->vVector == NULL)
								scan->vVector = new GrapaVector();
							scan->vVector->FromBytes(vScriptExec, pNameSpace, scan->mValue);
							if (scan->mValue.mLength == 0)
								scan->mNull = true;
							scan->mValue.SetLength(0);
							scan->mValue.SetSize(0);
			...
			else
			{
				...
				if (result)
				{
					if (result->mValue.mToken == GrapaTokenType::LIST || result->mValue.mToken == GrapaTokenType::TUPLE || result->mValue.mToken == GrapaTokenType::GOBJ || result->mValue.mToken == GrapaTokenType::ERR || result->mValue.mToken == GrapaTokenType::XML || result->mValue.mToken == GrapaTokenType::EL || result->mValue.mToken == GrapaTokenType::TAG || result->mValue.mToken == GrapaTokenType::OP || result->mValue.mToken == GrapaTokenType::CODE || result->mValue.mToken == GrapaTokenType::ERR)
					{
						result->vQueue = new GrapaRuleQueue();
					...
					else if (result->mValue.mToken == GrapaTokenType::VECTOR)
					{
						if (result->vVector == NULL)
							result->vVector = new GrapaVector();
...
GrapaRuleEvent* GrapaLibraryRuleIncludeEvent::Optimize(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleEvent* pParam)
{
	...
	if (r1.vVal)
	{
		...
		if ((setValue.mLength >= 2 && setValue.mBytes[0] == 0 && setValue.mBytes[1] == 0) || (setValue.mLength > 4 && setValue.mBytes[0] == 'G' && setValue.mBytes[1] == 'R' && setValue.mBytes[2] == 'Z' && (setValue.mBytes[3] & 0x80) == 0))
		{
			...
			if (expanded.mToken == GrapaTokenType::GOBJ || expanded.mToken == GrapaTokenType::ERR || expanded.mToken == GrapaTokenType::LIST || expanded.mToken == GrapaTokenType::TUPLE)
			{
				...
				if (tq->mCount > 1 && expanded.mToken == GrapaTokenType::GOBJ)
					tx = tq->Search("op",idx);
				if (tx==NULL)
					tx = tq->Head();
				if (tx)
...
GrapaRuleEvent* GrapaLibraryRuleHttpSendEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (objEvent)
	{
		...
		if (header.vVal && header.vVal->mValue.mToken == GrapaTokenType::GOBJ && header.vVal->vQueue)
		{
			...
			while(t)
			{
				if (t->mName.StrLowerCmp("content-length") != 0)
				{
					...
					else if (t->mValue.mToken == GrapaTokenType::LIST || t->mValue.mToken == GrapaTokenType::TUPLE)
					{
						if (t->vQueue->mCount)
						{
							GrapaCHAR sep(", ");
					...
					else if (t->mValue.mToken == GrapaTokenType::GOBJ)
					{
						if (t->vQueue->mCount)
						{
							GrapaCHAR sep(", ");
...
{
	GrapaRuleEvent*result = new GrapaRuleEvent(GrapaTokenType::LIST, 0, "", "");
	result->vQueue = new GrapaRuleQueue();
	if (dim == pos + 1)
	{
...
GrapaRuleEvent* GrapaLibraryRuleRandomEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (bits)
	{
		if (r2.vVal && !r2.vVal->mNull)
		{
			...
			if (counts)
			{
				if ((r2.vVal->mValue.mToken == GrapaTokenType::LIST || r2.vVal->mValue.mToken == GrapaTokenType::TUPLE) && r2.vVal->vQueue && r2.vVal->vQueue->mCount)
				{
...
GrapaRuleEvent* GrapaLibraryRuleEncodeEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal && r2.vVal)
	{
		...
		else if (r2.vVal->mValue.mToken == GrapaTokenType::GOBJ)
		{
			s64 idx;
		...
		if (method.StrLowerCmp("rsa") == 0|| method.StrLowerCmp("bc") == 0 || method.StrLowerCmp("md") == 0 || method.StrLowerCmp("rpk") == 0)
		{
			GrapaEncode key;
			bool isset = true;
			if (r2.vVal && r2.vVal->mValue.mToken == GrapaTokenType::GOBJ) key.FROM(r2.vVal);
			else if (r3.vVal && r3.vVal->mValue.mToken == GrapaTokenType::GOBJ) key.FROM(r3.vVal);
			else isset = false;
			if (isset)
			{
				err = -1;
		...
		else if (method.StrLowerCmp("AES256") == 0)
		{
			...
			if (r2.vVal && r2.vVal->mValue.mToken == GrapaTokenType::GOBJ) sq = (GrapaRuleQueue*)r2.vVal->vQueue;
			else if (r3.vVal && r3.vVal->mValue.mToken == GrapaTokenType::GOBJ) sq = (GrapaRuleQueue*)r3.vVal->vQueue;
			if (sq)
			{
...
GrapaRuleEvent* GrapaLibraryRuleSignAddEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal && r2.vVal)
	{
		...
		bool isset = true;
		if (r2.vVal && r2.vVal->mValue.mToken == GrapaTokenType::GOBJ) key.FROM(r2.vVal);
		else if (r4.vVal && r4.vVal->mValue.mToken == GrapaTokenType::GOBJ) key.FROM(r4.vVal);
		else isset = false;
		if (isset)
		{
			GrapaBYTE enc;
...
GrapaRuleEvent* GrapaLibraryRuleSubEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	else if (r1.vVal && r2.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR && (r2.vVal->mValue.mToken == GrapaTokenType::VECTOR || r2.vVal->mValue.mToken == GrapaTokenType::LIST || r2.vVal->mValue.mToken == GrapaTokenType::TUPLE || r2.vVal->mValue.mToken == GrapaTokenType::INT || r2.vVal->mValue.mToken == GrapaTokenType::FLOAT))
	{
		result = new GrapaRuleEvent(GrapaTokenType::VECTOR, 0, "", "");
	...
	else if (r1.vVal && r2.vVal && r1.vVal->mValue.mToken == GrapaTokenType::LIST && (r2.vVal->mValue.mToken == GrapaTokenType::VECTOR || r2.vVal->mValue.mToken == GrapaTokenType::LIST || r2.vVal->mValue.mToken == GrapaTokenType::TUPLE || r2.vVal->mValue.mToken == GrapaTokenType::INT || r2.vVal->mValue.mToken == GrapaTokenType::FLOAT))
	{
		GrapaVector aa;
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaError err = -1;
...
GrapaRuleEvent* GrapaLibraryRuleMulEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal && r2.vVal)
	{
		...
		//	}
		//}
		else if ((r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE) && r1.vVal->vQueue && (r2.vVal->mValue.mToken == GrapaTokenType::INT || r2.vVal->mValue.mToken == GrapaTokenType::FLOAT))
		{
			switch (r2.vVal->mValue.mToken)
			{
			case GrapaTokenType::INT:
		...
		else if ((r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE || r1.vVal->mValue.mToken == GrapaTokenType::GOBJ || r1.vVal->mValue.mToken == GrapaTokenType::ERR || r1.vVal->mValue.mToken == GrapaTokenType::XML || r1.vVal->mValue.mToken == GrapaTokenType::EL || r1.vVal->mValue.mToken == GrapaTokenType::TAG || r1.vVal->mValue.mToken == GrapaTokenType::OP || r1.vVal->mValue.mToken == GrapaTokenType::CODE) && r1.vVal->vQueue && r2.vVal->mValue.mToken == GrapaTokenType::SYSID)
		{
			...
			else if (r2.vVal->mValue.Cmp("CSV") == 0)
			{
				...
				if ((x->mValue.mToken == GrapaTokenType::LIST || x->mValue.mToken == GrapaTokenType::TUPLE || x->mValue.mToken == GrapaTokenType::GOBJ || x->mValue.mToken == GrapaTokenType::ERR || x->mValue.mToken == GrapaTokenType::XML || x->mValue.mToken == GrapaTokenType::EL || x->mValue.mToken == GrapaTokenType::TAG) && x->vQueue)
				{
					x = (GrapaRuleEvent*)x->vQueue->Head();
					while (x)
					{
						if ((x->mValue.mToken == GrapaTokenType::LIST || x->mValue.mToken == GrapaTokenType::TUPLE || x->mValue.mToken == GrapaTokenType::GOBJ || x->mValue.mToken == GrapaTokenType::ERR || x->mValue.mToken == GrapaTokenType::XML || x->mValue.mToken == GrapaTokenType::EL || x->mValue.mToken == GrapaTokenType::TAG || x->mValue.mToken == GrapaTokenType::OP || x->mValue.mToken == GrapaTokenType::CODE))
						{
...
GrapaRuleEvent* GrapaLibraryRuleNotEvent::Run(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent *pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal)
	{
		...
		case GrapaTokenType::FLOAT:
		{
			// For FLOAT, check if the value is zero (including negative zero)
			GrapaFloat f(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, 0);
			f.FromBytes(r1.vVal->mValue);
			// Return TRUE (not) if the float is zero, FALSE if non-zero
			result = new GrapaRuleEvent(GrapaTokenType::BOOL, 0, "", (f == 0) ? "\1" : "");
			break;
		}
		case GrapaTokenType::INT:
		{
			// For INT, check if the value is zero
			GrapaInt i;
...
GrapaRuleEvent* GrapaLibraryRuleVectorEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal)
	{
		if (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE || r1.vVal->mValue.mToken == GrapaTokenType::GOBJ || r1.vVal->mValue.mToken == GrapaTokenType::ERR)
		{
			result = new GrapaRuleEvent(0, GrapaCHAR(""), GrapaCHAR(""));
			result->mValue.mToken = GrapaTokenType::VECTOR;
			result->vVector = new GrapaVector();
	...
	if (r1.vVal)
	{
		...
		else
		{
			...
			else
			{
				...
				case GrapaTokenType::MODEL: result = new GrapaRuleEvent(GrapaTokenType::STR, 0, "", "$MODEL"); break;
				case GrapaTokenType::GOBJ: result = new GrapaRuleEvent(GrapaTokenType::STR, 0, "", "$GOBJ"); break;
...
GrapaRuleEvent* GrapaLibraryRuleDescribeEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal)
	{
		...
		if (r2.vVal && (r2.vVal->mValue.mToken == GrapaTokenType::OBJ || r2.vVal->mValue.mToken == GrapaTokenType::GOBJ || r2.vVal->mValue.mToken == GrapaTokenType::ERR))
		{
		...
		case GrapaTokenType::LIST:
			{
				if (r1.vVal->vQueue)
				{
					...
					if (format == "json")
					{
						description = "{\"type\":\"list\",\"length\":" + std::to_string(count);
						if (include_structure && count > 0)
						{
							...
							for (u64 i = 0; i < count && i < 5; i++) // Limit to first 5 elements
							{
								...
								case GrapaTokenType::GOBJ: description += "\"gobj\""; break;
								case GrapaTokenType::ERR: description += "\"error\""; break;
					...
					else
					{
						...
						if (include_structure && count > 0)
						{
							...
							for (u64 i = 0; i < count && i < 3; i++) // Limit to first 3 elements
							{
								...
								case GrapaTokenType::INT: description += "integer"; break;
								case GrapaTokenType::FLOAT: description += "float"; break;
								case GrapaTokenType::LIST: description += "gobj"; break;
								case GrapaTokenType::GOBJ: description += "gro"; break;
								case GrapaTokenType::ERR: description += "error"; break;
								default: description += "unknown"; break;
								}
							}
...
GrapaRuleEvent* GrapaLibraryRuleMidTrimEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal && itemsV.vVal && itemsV.vVal && (itemsV.vVal->mValue.mToken == GrapaTokenType::LIST || itemsV.vVal->mValue.mToken == GrapaTokenType::TUPLE)
		&& (r1.vVal->mValue.mToken == GrapaTokenType::STR || r1.vVal->mValue.mToken == GrapaTokenType::RAW))
	{
		...
		if ((r1.vVal->mValue.mLength)&& ((offset + blocksize) <= r1.vVal->mValue.mLength))
		{
			...
			while (row)
			{
				...
				while (item->mValue.mToken == GrapaTokenType::PTR && item->vRulePointer) item = item->vRulePointer;
				if ((item->mValue.mToken == GrapaTokenType::LIST || item->mValue.mToken == GrapaTokenType::TUPLE) && item->vQueue->mCount >= 3)
				{
...
GrapaRuleEvent* GrapaLibraryRuleInterpolateEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL); // params ($GOBJ)
	...
	if (r2.vVal && r2.vVal->mValue.mToken == GrapaTokenType::GOBJ && r2.vVal->vQueue)
	{
		GrapaRuleEvent* ex = r2.vVal; 
		while (ex && ex->mValue.mToken == GrapaTokenType::PTR && ex->vRulePointer) ex = ex->vRulePointer;
		if (ex && ex->mValue.mToken == GrapaTokenType::GOBJ && ex->vQueue)
		{
			ex = ex->vQueue->Head();
			while (ex)
			{
...
GrapaRuleEvent* GrapaLibraryRuleMatchEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	bool hasValue = (grep_result && grep_result->mValue.mToken == GrapaTokenType::LIST && grep_result->vQueue && grep_result->vQueue->mCount);
	grep_result->CLEAR();
	delete grep_result;
...
GrapaRuleEvent* GrapaLibraryRuleSplitEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (r1.vVal && r2.vVal)
	{
		...
		else if ((r1.vVal->mValue.mToken == GrapaTokenType::GOBJ || r1.vVal->mValue.mToken == GrapaTokenType::ERR || r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE || r1.vVal->mValue.mToken == GrapaTokenType::XML || r1.vVal->mValue.mToken == GrapaTokenType::TAG))
		{
			result = new GrapaRuleEvent();
			result->mValue.mToken = GrapaTokenType::LIST;
			result->vQueue = new GrapaRuleQueue();
	...
	if (r1.vVal) // && (!r2.vVal || r2.vVal->mNull))
	{
		...
		if ((r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE || r1.vVal->mValue.mToken == GrapaTokenType::GOBJ || r1.vVal->mValue.mToken == GrapaTokenType::ERR || r1.vVal->mValue.mToken == GrapaTokenType::XML || r1.vVal->mValue.mToken == GrapaTokenType::EL || r1.vVal->mValue.mToken == GrapaTokenType::TAG || r1.vVal->mValue.mToken == GrapaTokenType::OP || r1.vVal->mValue.mToken == GrapaTokenType::CODE) && r1.vVal->vQueue)
		{
			...
			while (e)
			{
				...
				else if ((e2->mValue.mToken == GrapaTokenType::LIST || e2->mValue.mToken == GrapaTokenType::TUPLE || e2->mValue.mToken == GrapaTokenType::GOBJ || e2->mValue.mToken == GrapaTokenType::ERR) && e2->vQueue)
				{
					if (!isQueue)
					{
						isQueue = true;
				...
				else if ((e2->mValue.mToken == GrapaTokenType::MODEL) && e2->vModel)
				{
					if (!isModel)
					{
						isModel = true;
...
GrapaRuleEvent* GrapaLibraryRuleVectorTransposeEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::VECTOR))
	...
	else if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		GrapaVector q;
...
GrapaRuleEvent* GrapaLibraryRuleVectorRrefEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::VECTOR))
...
GrapaRuleEvent* GrapaLibraryRuleVectorInvEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::INT))
...
GrapaRuleEvent* GrapaLibraryRuleVectorDetEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::VECTOR))
...
GrapaRuleEvent* GrapaLibraryRuleVectorRankEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::VECTOR))
...
GrapaRuleEvent* GrapaLibraryRuleVectorSolveEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::VECTOR))
...
GrapaRuleEvent* GrapaLibraryRuleVectorCovEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorSumEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	...
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		GrapaVector aa;
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaVector cc;
...
GrapaRuleEvent* GrapaLibraryRuleVectorMeanEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorMinEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorMaxEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorStdEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorVarEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorShapeEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR)
...
GrapaRuleEvent* GrapaLibraryRuleVectorReShapeEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorDotEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorTriUEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorTriLEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorEigHEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
...
GrapaRuleEvent* GrapaLibraryRuleVectorIdentityEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::INT)
...
GrapaRuleEvent* GrapaLibraryRuleVectorDiagEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
...
GrapaRuleEvent* GrapaLibraryRuleVectorNormEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	...
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		...
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaVector cc;
		if (aa.Norm(vScriptExec, cc, axis == 0) || cc.mData == NULL)
		{
			result = Error(vScriptExec, pNameSpace, -1);
		}
		else
	...
	else if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR)
	{
		result = new GrapaRuleEvent(GrapaTokenType::VECTOR, 0, "", "");
		result->vVector = new GrapaVector();
		if (r1.vVal->vVector->Norm(vScriptExec, *result->vVector, axis == 0))
		{
			result->CLEAR();
			delete result;
			result = Error(vScriptExec, pNameSpace, -1);
...
GrapaRuleEvent* GrapaLibraryRuleVectorModeEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	...
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		...
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaVector cc;
		if (aa.Mode(vScriptExec, cc, axis == 0) || cc.mData == NULL)
		{
			result = Error(vScriptExec, pNameSpace, -1);
		}
		else
	...
	else if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR)
	{
		result = new GrapaRuleEvent(GrapaTokenType::VECTOR, 0, "", "");
		result->vVector = new GrapaVector();
		if (r1.vVal->vVector->Mode(vScriptExec, *result->vVector, axis == 0))
		{
			result->CLEAR();
			delete result;
			result = Error(vScriptExec, pNameSpace, -1);
...
GrapaRuleEvent* GrapaLibraryRuleVectorMedianEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	...
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		...
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaVector cc;
		if (aa.Median(vScriptExec, cc, axis == 0) || cc.mData == NULL)
		{
			result = Error(vScriptExec, pNameSpace, -1);
		}
		else
	...
	else if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR)
	{
		result = new GrapaRuleEvent(GrapaTokenType::VECTOR, 0, "", "");
		result->vVector = new GrapaVector();
		if (r1.vVal->vVector->Median(vScriptExec, *result->vVector, axis == 0))
		{
			result->CLEAR();
			delete result;
			result = Error(vScriptExec, pNameSpace, -1);
...
GrapaRuleEvent* GrapaLibraryRuleVectorSkewEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	...
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		...
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaVector cc;
		if (aa.Skew(vScriptExec, cc, axis == 0) || cc.mData == NULL)
		{
			result = Error(vScriptExec, pNameSpace, -1);
		}
		else
	...
	else if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR)
	{
		result = new GrapaRuleEvent(GrapaTokenType::VECTOR, 0, "", "");
		result->vVector = new GrapaVector();
		if (r1.vVal->vVector->Skew(vScriptExec, *result->vVector, axis == 0))
		{
			result->CLEAR();
			delete result;
			result = Error(vScriptExec, pNameSpace, -1);
...
GrapaRuleEvent* GrapaLibraryRuleVectorKurtosisEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	GrapaRuleEvent* result = NULL;
	GrapaLibraryParam r1(vScriptExec, pNameSpace, pInput ? pInput->Head(0) : NULL);
	GrapaLibraryParam r2(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	...
	if (r1.vVal && (r1.vVal->mValue.mToken == GrapaTokenType::LIST || r1.vVal->mValue.mToken == GrapaTokenType::TUPLE))
	{
		...
		aa.FROM(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, r1.vVal, 0);
		GrapaVector cc;
		if (aa.Kurtosis(vScriptExec, cc, axis == 0) || cc.mData == NULL)
		{
			result = Error(vScriptExec, pNameSpace, -1);
		}
		else
	...
	else if (r1.vVal && r1.vVal->mValue.mToken == GrapaTokenType::VECTOR)
	{
		result = new GrapaRuleEvent(GrapaTokenType::VECTOR, 0, "", "");
		result->vVector = new GrapaVector();
		if (r1.vVal->vVector->Kurtosis(vScriptExec, *result->vVector, axis == 0))
		{
			result->CLEAR();
			delete result;
			result = Error(vScriptExec, pNameSpace, -1);
...
GrapaRuleEvent* calculate_string_similarity(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* str1, GrapaRuleEvent* str2, GrapaCHAR& method, GrapaRuleEvent* options)
{
	GrapaRuleEvent* result = NULL;
	...
	// Parse advanced options for Cosine and Jaccard
	std::string cosine_method = "auto";  // Default to auto-selection
	std::vector<std::string> corpus;
	bool case_sensitive = true;   // Default to case-sensitive
	std::string jaccard_method = "word";  // Default to word-based
	int jaccard_n = 2;  // Default n-gram size
	
	if (options && options->mValue.mToken == GrapaTokenType::GOBJ && options->vQueue)
	{
		// Parse Cosine options
		s64 method_index = 0;
		GrapaRuleEvent* method_opt = options->vQueue->Search(GrapaCHAR("method"), method_index);
		if (method_opt && method_opt->mValue.mToken == GrapaTokenType::STR)
		{
			std::string method_str_opt(reinterpret_cast<const char*>(method_opt->mValue.mBytes), method_opt->mValue.mLength);
			if (method_str_opt == "word_freq" || method_str_opt == "tfidf")
			{
				cosine_method = method_str_opt;
			}
		}
		
		// Parse corpus option
		s64 corpus_index = 0;
		GrapaRuleEvent* corpus_opt = options->vQueue->Search(GrapaCHAR("corpus"), corpus_index);
		if (corpus_opt)
		{
		...
		s64 case_index = 0;
		GrapaRuleEvent* case_opt = options->vQueue->Search(GrapaCHAR("case_sensitive"), case_index);
		if (case_opt)
		{
		...
		// Parse Jaccard options
		s64 jaccard_method_index = 0;
		GrapaRuleEvent* jaccard_method_opt = options->vQueue->Search(GrapaCHAR("jaccard_method"), jaccard_method_index);
		if (jaccard_method_opt && jaccard_method_opt->mValue.mToken == GrapaTokenType::STR)
		{
			jaccard_method = std::string(reinterpret_cast<const char*>(jaccard_method_opt->mValue.mBytes), jaccard_method_opt->mValue.mLength);
		}
		
		s64 jaccard_n_index = 0;
		GrapaRuleEvent* jaccard_n_opt = options->vQueue->Search(GrapaCHAR("jaccard_n"), jaccard_n_index);
		if (jaccard_n_opt && jaccard_n_opt->mValue.mToken == GrapaTokenType::INT)
		{
			GrapaInt nInt;
			nInt.FromBytes(jaccard_n_opt->mValue);
			jaccard_n = (int)nInt.LongValue();
		}
	}
	
	// Auto-select cosine method if not specified
	if (cosine_method == "auto")
	{
		if (!corpus.empty())
		{
			cosine_method = "tfidf";  // Use TF-IDF if corpus provided
		}
		else
		{
			cosine_method = "word_freq";  // Use word frequency otherwise
		}
	}
	...
	if (!case_sensitive)
	{
		string1 = grapa_case_fold_string(string1);
		string2 = grapa_case_fold_string(string2);
	}
	...
	else if (method_str == "cosine" || method_str == "cosine_similarity")
	{
		...
		if (cosine_method == "tfidf" && !corpus.empty())
		{
			similarity = calculate_cosine_similarity_tfidf(string1, string2, corpus);
		}
		else
		{
	...
	else if (method_str == "jaccard" || method_str == "jaccard_similarity")
	{
		...
		double similarity = calculate_jaccard_similarity(string1, string2, jaccard_method, jaccard_n);
		result = new GrapaRuleEvent(0, GrapaCHAR(), GrapaFloat(similarity).getBytes());
	}
	else if (method_str == "tfidf" || method_str == "cosine_tfidf")
	{
		...
		{
			// Fallback to basic cosine similarity if no corpus provided
			similarity = calculate_cosine_similarity(string1, string2);
		}
		result = new GrapaRuleEvent(0, GrapaCHAR(), GrapaFloat(similarity).getBytes());
	}
...
// Helper function to calculate array-object similarity
...
bool are_values_similar(GrapaRuleEvent* val1, GrapaRuleEvent* val2)
{
	...
	// Same type and value
	if (val1->mValue.mToken == val2->mValue.mToken)
	{
		if (val1->mValue.mToken == GrapaTokenType::STR || val1->mValue.mToken == GrapaTokenType::ID)
		{
			// String comparison
			if (val1->mValue.mBytes && val2->mValue.mBytes && val1->mValue.mLength > 0 && val2->mValue.mLength > 0)
			{
				std::string str1(reinterpret_cast<const char*>(val1->mValue.mBytes), val1->mValue.mLength);
				std::string str2(reinterpret_cast<const char*>(val2->mValue.mBytes), val2->mValue.mLength);
				return str1 == str2;
			}
			return false;
		}
		else if (val1->mValue.mToken == GrapaTokenType::INT)
		{
			// Integer comparison
			GrapaInt int1, int2;
		...
		{
			// Float comparison
			GrapaFloat float1, float2;
			float1.FromBytes(val1->mValue);
			float2.FromBytes(val2->mValue);
			return std::abs(float1.ToDouble() - float2.ToDouble()) < 1e-9;
		}
		else if (val1->mValue.mToken == GrapaTokenType::BOOL)
		{
			// Boolean comparison
			if (val1->mValue.mBytes && val2->mValue.mBytes && val1->mValue.mLength > 0 && val2->mValue.mLength > 0)
			{
				return val1->mValue.mBytes[0] == val2->mValue.mBytes[0];
			}
			return false;
		}
	}
...
GrapaError get_table_pointer_similarity(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* datasource, GrapaCHAR& datafield, u64 pId, GrapaRuleEvent* actual_item)
{
	if (actual_item == NULL) return -1;
	GrapaCHAR value;
	GrapaError err = datasource->vDatabase->FieldGet(pId, datafield, value);
	if (err) return err;
	actual_item->mName.FROM(datafield);
...
class GrapaPointerSimilarityWorkEvent : public GrapaWorkEvent
{
public:
	GrapaVector* vVector;
	GrapaScriptExec* vScriptExec;
	...
	GrapaRuleEvent* vQuery;
	GrapaCHAR* vMethod;
	GrapaRuleEvent* vDataSource;
	GrapaCHAR* vDatafield;
	std::vector<GrapaRuleEvent*> *vData;
	std::vector<std::pair<int, GrapaFloat>> vResult;
	
	GrapaPointerSimilarityWorkEvent(GrapaWorkQueue* vQueue, GrapaScriptExec* pScriptExec, GrapaNames* pNameSpace, std::vector<int>* pIndexes, GrapaRuleEvent* pQuery, GrapaCHAR* pMethod, GrapaRuleEvent* pDataSource, GrapaCHAR* pDatafield, std::vector<GrapaRuleEvent*>* pData)
	{
		this->vScriptExec = pScriptExec;
		this->vNameSpace = pNameSpace;
		this->vIndexes = pIndexes;
		this->vQuery = pQuery;
		this->vMethod = pMethod;
		this->vDataSource = pDataSource;
		this->vDatafield = pDatafield;
		this->vData = pData;
		Set(vQueue);
	}
	virtual ~GrapaPointerSimilarityWorkEvent()
	{
		CLEAR();
	}
	virtual void CLEAR()
	...
	virtual void Running()
	{
		...
		for (size_t i = 0; i < (*vIndexes).size(); i++)
		{
			...
			if (vDataSource->mValue.mToken == GrapaTokenType::LIST)
				actual_item = (*vData)[index];
			else if ((vDataSource->mValue.mToken == GrapaTokenType::OBJ && vDataSource->vClass->mName.Cmp("$file") == 0) || vDataSource->mValue.mToken == GrapaTokenType::TABLE)
			{
				GrapaError err = get_table_pointer_similarity(vScriptExec, vNameSpace, vDataSource, *vDatafield, index, &table_item);
				if (err)
					continue;
			...
			if (vQuery->mValue.mToken == GrapaTokenType::STR && actual_item->mValue.mToken == GrapaTokenType::STR)
			{
				// String similarity
				GrapaRuleEvent* temp_result = calculate_string_similarity(vScriptExec, vNameSpace, actual_item, vQuery, *vMethod);
				if (temp_result && temp_result->mValue.mToken == GrapaTokenType::FLOAT)
				{
					similarity = GrapaFloat(temp_result->mValue);
				}
			}
			else if (vQuery->mValue.mToken == GrapaTokenType::VECTOR && actual_item->mValue.mToken == GrapaTokenType::VECTOR)
			{
				// Vector similarity with optimized inline calculation
				if (actual_item->vVector && vQuery->vVector)
				{
					GrapaVector* query_vec = vQuery->vVector;
					...
					if (query_vec->mData && item_vec->mData && query_vec->mDim == 1 && item_vec->mDim == 1 && query_vec->mCounts[0] == item_vec->mCounts[0])
					{
						...
						if (vMethod->StrLowerCmp("cosine") == 0 || vMethod->StrLowerCmp("cosine_similarity") == 0)
						{
						...
						else
						{
							...
							GrapaError err = item_vec->Similarity(vScriptExec, vNameSpace, *query_vec, result_vector, *vMethod);
			...
			else if (vQuery->mValue.mToken == GrapaTokenType::GOBJ && actual_item->mValue.mToken == GrapaTokenType::GOBJ)
			{
				// Object similarity
				similarity = GrapaFloat(calculate_object_similarity(actual_item, vQuery));
			}
			vResult.push_back({ index, similarity });
		}
	};
};

class GrapaPointerSimilarityWorkQueue : public GrapaWorkQueue
{
public:
	virtual ~GrapaPointerSimilarityWorkQueue() {
		GrapaPointerSimilarityWorkQueue::CLEAR();
	}
	virtual void CLEAR()
	{
		GrapaPointerSimilarityWorkEvent* e = (GrapaPointerSimilarityWorkEvent*)PopHead();
		while (e)
		{
			e->CLEAR();
			delete e;
			e = (GrapaPointerSimilarityWorkEvent*)PopHead();
		}
	}
};

// Helper function to calculate pointer-based similarity (new in-memory approach)
GrapaRuleEvent* calculate_pointer_similarity(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* index_list, GrapaRuleEvent* query, GrapaCHAR& method, GrapaRuleEvent* datasource, GrapaCHAR& datafield, int top_n, double threshold, std::string sort, bool include_scores, bool include_items)
{
	GrapaRuleEvent* result = NULL;
	if (datasource == NULL)
		return NULL;
	...
	for (const auto& sim : similarities)
	{
		...
		if (include_items)
		{
			...
			else if ((datasource->mValue.mToken == GrapaTokenType::OBJ && datasource->vClass->mName.Cmp("$file") == 0) || datasource->mValue.mToken == GrapaTokenType::TABLE)
			{
				...
				GrapaError err = get_table_pointer_similarity(vScriptExec, pNameSpace, datasource, datafield, sim.first, item_field);
				if (err)
				{
					item_field->CLEAR();
					delete item_field;
	...
	if (!similarities.empty())
	{
		...
		if (include_items)
		{
			...
			else if ((datasource->mValue.mToken == GrapaTokenType::OBJ && datasource->vClass->mName.Cmp("$file") == 0) || datasource->mValue.mToken == GrapaTokenType::TABLE)
			{
				...
				GrapaError err = get_table_pointer_similarity(vScriptExec, pNameSpace, datasource, datafield, best_index, best_match_key);
				if (err)
				{
...
GrapaRuleEvent* calculate_array_vector_similarity(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* array, GrapaRuleEvent* query, GrapaCHAR& method, int top_n, double threshold, std::string sort, bool include_scores, bool include_items)
{
	...
	// Calculate similarities with optimized inline calculation
	std::vector<std::pair<int, double>> similarities;
	
	// Get query vector data for efficient access
	GrapaVector* query_vec = query->vVector;
	if (!query_vec || !query_vec->mData || query_vec->mDim != 1)
		return result;
	...
	for (size_t i = 0; i < array_items.size(); i++)
	{
		GrapaVector* item_vec = array_items[i]->vVector;
		if (!item_vec || !item_vec->mData || item_vec->mDim != 1 || item_vec->mCounts[0] != query_len)
			continue;
		...
		if (method.StrLowerCmp("cosine") == 0 || method.StrLowerCmp("cosine_similarity") == 0)
		{
			...
			for (u64 j = 0; j < query_len; j++)
			{
				...
				if (p1.aa && p2.aa)
				{
					double a = p1.aa->ToDouble();
					double b = p2.aa->ToDouble();
			...
			// Calculate final cosine similarity
			double norm_a = sqrt(sum_a2);
			double norm_b = sqrt(sum_b2);
			if (norm_a > 0 && norm_b > 0)
			{
				similarity = sum_ab / (norm_a * norm_b);
			}
		...
		else
		{
			...
			GrapaError err = query_vec->Similarity(vScriptExec, pNameSpace, *item_vec, temp_result, method);
			
			if (!err && temp_result.mCounts && temp_result.mCounts[0] > 0)
			{
...
GrapaRuleEvent* GrapaLibraryRuleSimilarityEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (params_param.vVal && params_param.vVal->mValue.mToken == GrapaTokenType::GOBJ && params_param.vVal->vQueue)
	{
		...
		while (params_event_head)
		{
			...
			else if (key_str == "datafield")
			{
				datafield.FROM(params_event->mValue);
			}
	...
	if (array_param.vVal && query_param.vVal && array_param.vVal->mValue.mToken == GrapaTokenType::LIST && datasource)
	{
		...
		if (is_pointer_list)
		{
			...
			result = calculate_pointer_similarity(vScriptExec, pNameSpace, array_param.vVal, query_param.vVal, method, datasource, datafield, top_n, threshold, sort, include_scores, include_items);
		}
	}
	...
	else if (array_param.vVal && query_param.vVal && query_param.vVal->mValue.mToken == GrapaTokenType::LIST && datasource)
	{
		...
		if (is_pointer_list)
		{
			...
			result = calculate_pointer_similarity(vScriptExec, pNameSpace, query_param.vVal, array_param.vVal, method, datasource, datafield, top_n, threshold, sort, include_scores, include_items);
		}
	}
	...
	else if (array_param.vVal && query_param.vVal && array_param.vVal->mValue.mToken == GrapaTokenType::STR && query_param.vVal->mValue.mToken == GrapaTokenType::STR)
	{
		...
		result = calculate_string_similarity(vScriptExec, pNameSpace, array_param.vVal, query_param.vVal, method, params_param.vVal);
	}
...
GrapaRuleEvent* GrapaLibraryRuleGenHashSetEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	GrapaLibraryParam method_helper(vScriptExec, pNameSpace, pInput ? pInput->Head(1) : NULL);
	GrapaLibraryParam count_helper(vScriptExec, pNameSpace, pInput ? pInput->Head(2) : NULL);
	GrapaLibraryParam hyperplanes_helper(vScriptExec, pNameSpace, pInput ? pInput->Head(3) : NULL);
	GrapaLibraryParam randseed_helper(vScriptExec, pNameSpace, pInput ? pInput->Head(4) : NULL);
	...
	GrapaCHAR method("cosine");
	if (method_helper.vVal && method_helper.vVal->mValue.mLength) {
		method.FROM(method_helper.vVal->mValue);
	}
	...
	if (count_helper.vVal && count_helper.vVal->mValue.mToken == GrapaTokenType::INT) {
		GrapaInt count_int;
		count_int.FromBytes(count_helper.vVal->mValue);
		count = (int)count_int.LongValue();
	}

	if (hyperplanes_helper.vVal && hyperplanes_helper.vVal->mValue.mToken == GrapaTokenType::INT) {
		GrapaInt hyperplanes_int;
		hyperplanes_int.FromBytes(hyperplanes_helper.vVal->mValue);
		hyperplanes = (int)hyperplanes_int.LongValue();
	}

	if (randseed_helper.vVal && randseed_helper.vVal->mValue.mToken == GrapaTokenType::INT) {
		GrapaInt randseed_int;
		randseed_int.FromBytes(randseed_helper.vVal->mValue);
		randseed = (int)randseed_int.LongValue();
	}
	...
	if (obj_helper.vVal->mValue.mToken == GrapaTokenType::VECTOR) {
		...
		if (obj_helper.vVal->vVector) {
			GrapaError err = obj_helper.vVal->vVector->GenHashSet(vScriptExec, pNameSpace, method, count, hyperplanes, randseed, *sets);
			if (err != 0) {
				delete sets;
				return Error(vScriptExec, pNameSpace, err);
			}
		...
		if (sets && sets->vQueue && sets->vQueue->Head() && sets->vQueue->Head() && sets->vQueue->Head()->vQueue && sets->vQueue->Head()->vQueue->Head()->vVector)
			dimension = sets->vQueue->Head()->vQueue->Head()->vVector->mSize;
	}
	else if (obj_helper.vVal->mValue.mToken == GrapaTokenType::INT) {
		// Integer dimension - create a dummy vector and use its GenHashSet
		GrapaInt dim_int;
		dim_int.FromBytes(obj_helper.vVal->mValue);
		dimension = (int)dim_int.LongValue();
		...
		dummy_vector->mDim = 1;
		dummy_vector->mCounts = (u64*)GrapaMem::Create(sizeof(u64));
		dummy_vector->mCounts[0] = dimension;
		dummy_vector->mSize = dimension;
		dummy_vector->mData = (GrapaVectorItem*)GrapaMem::Create(dummy_vector->mSize * dummy_vector->mBlock);
		memset(dummy_vector->mData, 0, dummy_vector->mSize * dummy_vector->mBlock);
		
		// Initialize with zeros
		for (int i = 0; i < dimension; i++) {
			GrapaFloat gf(vScriptExec->vScriptState->mItemState.mFloatFix, vScriptExec->vScriptState->mItemState.mFloatMax, vScriptExec->vScriptState->mItemState.mFloatExtra, 0);
			dummy_vector->Set(i, gf);
		}
		
		GrapaError err = dummy_vector->GenHashSet(vScriptExec, pNameSpace, method, count, hyperplanes, randseed, *sets);
		...
		if (method.StrLowerCmp("jaccard") == 0 || method.StrLowerCmp("levenshtein") == 0 || 
			...
			for (int set_idx = 0; set_idx < count; set_idx++) {
				...
				sets->vQueue->PushTail(set_event);
			}
		} else {
			delete sets;
		...
		if (method.StrLowerCmp("metadata") == 0 || method.StrLowerCmp("object") == 0 ||
			...
			dimension = (int)field_names.size();
	...
	result->mValue.mToken = GrapaTokenType::GOBJ;
	result->vQueue = new GrapaRuleQueue();
	result->vQueue->PushTail(new GrapaRuleEvent(0, GrapaCHAR("method"), method));
...
GrapaRuleEvent* GrapaLibraryRuleForEvent::HandleForIn(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleQueue* pInput)
{
    ...
    else if (collectionVal->mValue.mToken == GrapaTokenType::GOBJ || collectionVal->mValue.mToken == GrapaTokenType::ERR || collectionVal->mValue.mToken == GrapaTokenType::LIST)
    {
...
GrapaRuleEvent* GrapaLibraryRuleForEvent::HandleForFrom(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleQueue* pInput)
{
    ...
    while (true)
    {
        ...
        // Increment or decrement based on range direction
        if (startInt <= endInt)
        {
...
GrapaRuleEvent* GrapaLibraryRuleForEvent::HandleForFromStep(GrapaScriptExec *vScriptExec, GrapaNames* pNameSpace, GrapaRuleQueue* pInput)
{
    ...
    // Evaluate start, end, and step conditions once before the loop
    GrapaRuleEvent* startResult = vScriptExec->ProcessPlan(pNameSpace, startEvent);
    GrapaRuleEvent* endResult = vScriptExec->ProcessPlan(pNameSpace, endEvent);
    ...
    // Extract integer values
    GrapaInt startInt, endInt, stepInt;
    if (startVal->mValue.mToken != GrapaTokenType::INT || 
        endVal->mValue.mToken != GrapaTokenType::INT ||
...
GrapaRuleEvent* GrapaLibraryRuleWidgetGetEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
	...
	if (objEvent)
	{
		...
		//	}
		//}
		//else if (r2.vVal->mValue.mToken == GrapaTokenType::LIST || r2.vVal->mValue.mToken == GrapaTokenType::TUPLE)
		//{
...
GrapaRuleEvent* GrapaLibraryRuleModelLoadEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
    ...
    GrapaCHAR modelPath(r2.vVal->mValue);
    GrapaCHAR backend(r3.vVal->mValue);
...
GrapaRuleEvent* GrapaLibraryRuleModelGenEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
    ...
    GrapaCHAR prompt(r2.vVal->mValue);
...
GrapaRuleEvent* GrapaLibraryRuleModelInfoEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
    ...
    // Get model info
    result = objEvent->vModel->GetModelInfo();
...
GrapaRuleEvent* GrapaLibraryRuleModelParamsEvent::Run(GrapaScriptExec* vScriptExec, GrapaNames* pNameSpace, GrapaRuleEvent* pOperation, GrapaRuleQueue* pInput)
{
    ...
    if (params && params->mValue.mToken == GrapaTokenType::GOBJ) {
        ...
        result = objEvent->vModel->GetParams();
    }
