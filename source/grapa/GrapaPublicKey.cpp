...
bool GrapaPublicKey::FROM(GrapaRuleEvent* pKey)
{
	Clear();
...
GrapaRuleEvent* GrapaPublicKey::GenKeys(const GrapaCHAR& pMethod, GrapaRuleEvent* pParams)
{
	Clear();
...
bool GrapaPublicKey::Encode(const GrapaBYTE& pData, GrapaBYTE& pEnc, const GrapaInt& pPublicE)
{
	pEnc.SetLength(0);
...
bool GrapaPublicKey::Decode(const GrapaBYTE& pEnc, GrapaBYTE& pData, const GrapaInt& pPrivateD)
{
	pData.SetLength(0);
...
bool GrapaPublicKey::Sign(GrapaRuleEvent* pData, GrapaBYTE& pSignature, GrapaRuleEvent* pParams)
{
	if (mRSA)
	{
...
bool GrapaPublicKey::SignAdd(GrapaRuleEvent* pData, GrapaBYTE& pSignature, GrapaRuleEvent* pParams)
{
	return(false);
}
...
bool GrapaPublicKey::Verify(GrapaRuleEvent* pData, const GrapaBYTE& pSignature, GrapaRuleEvent* pParams)
{
	bool match = false;
	if (mRSA)
	{
...
bool GrapaPublicKey::VerifyRecover(GrapaBYTE& pData, const GrapaBYTE& pSignature)
{
	if (mRSA)
	{
		EVP_PKEY* key = EVP_PKEY_new();
...
bool GrapaPublicKey::Secret(GrapaRuleEvent* pKey, GrapaBYTE& pSecret)
{
	pSecret.SetLength(0);
