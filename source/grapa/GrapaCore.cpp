...
void GrapaCore::SetFile(GrapaFile *pFile)
{
	CloseFile();
	mFile = pFile;
}

GrapaError GrapaCore::OpenFile(const char *fileName, char mode)
{
	GrapaError err;
...
u64 GrapaCore::RootTree(u8& pType)
{
...
GrapaError GrapaCore::CloseFile()
{
	if (!mFile) return(0);
...
GrapaError GrapaCore::Create(const char *fileName)
{
	GrapaError err;
...
GrapaError GrapaCore::RemoveFile(const char *fileName)
{
	GrapaError err;
...
GrapaError GrapaCore::FlushFile()
{
	GrapaError err;
	if (!mFile) return(-1);
	err = mFile->Flush();
...
GrapaError GrapaCore::ClearFile()
{
	GrapaError err;
	GrapaBlockFileHeader hdr;
	GrapaBlockFirst fst;
...
GrapaError GrapaCore::PurgeFile()
{
	GrapaError err;
	if (!mFile) return(-1);
	GrapaBlockFileHeader hdr;
...
GrapaError	GrapaCore::GetFlags(u8& settings)
{
	GrapaError err;
...
GrapaError	GrapaCore::SetFlags(u8 settings)
{
	GrapaError err;
...
GrapaError	GrapaCore::GetCompressSize(u8& size)
{
	GrapaError err;
...
GrapaError	GrapaCore::SetCompressSize(u8 size)
{
	GrapaError err;
...
GrapaError GrapaCore::SetFileTree (u64 firstTree, bool deleteExisting)
{
	GrapaError err;
	GrapaBlockFileHeader hdr;
	err = hdr.Read(mFile,0);
...
u64 GrapaCore::FirstTree(u64 treePtr)
{
	GrapaError err;
	GrapaBlockFileHeader hdr;
	if (treePtr==0L)
...
GrapaError GrapaCore::NewTree(u64& treePtr, u8 treeType, u64 parentTree, u8 nodeCount)
{
	GrapaError err=0;
	GrapaBlockTree kb;
	u64 offset;
...
GrapaError	GrapaCore::DeleteTree(u64 treePtr)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError GrapaCore::EmptyTree(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError GrapaCore::SetTreeIndex(GrapaCursor& cursor, u64 indexTree)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError GrapaCore::GetTreeIndex(GrapaCursor& cursor, u64& indexTree)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError GrapaCore::SetTreeStore(GrapaCursor& cursor, u64 storeTree, u8 storeType)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError GrapaCore::GetTreeStore(GrapaCursor& cursor, u64& storeTree, u8& storeType)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError	GrapaCore::GetTreeSize(GrapaCursor& cursor, u64& itemCount)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError	GrapaCore::GetTreeDirty(GrapaCursor& cursor, bool& isDirty)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError	GrapaCore::SetTreeDirty(GrapaCursor& cursor, bool isDirty)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError	GrapaCore::GetTreeType(GrapaCursor& cursor, u8& treeType)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError	GrapaCore::SetTreeType(GrapaCursor& cursor, u8 treeType)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError GrapaCore::GetTreeParent(GrapaCursor& cursor, u64& parentTree)
{
	GrapaError err = 0;
	GrapaBlockTree kb;
...
GrapaError	GrapaCore::NewData(u8 dataType, u64 parentTree, u64 dataSize, u64 growBlockSize, u64 growBlocks, u64& itemPtr, bool clear)
{
	GrapaError err=-1;
...
GrapaError	GrapaCore::DeleteData(u64 itemPtr)
{
	GrapaError err = 0;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::SetDataSize(u64 itemPtr, u64 dataSize, u64 dataLength, u8 encodeType)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::GetDataSize(u64 itemPtr, u64& growBlockSize, u64& dataSize, u64& dataLength, u8& encodeType)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError GrapaCore::SetFieldType(u64 itemPtr, u8 fieldType)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError GrapaCore::GetFieldType(u64 itemPtr, u8& fieldType)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::ClearDataValue(u64 itemPtr, u64 offset, u64 bufferSize)
{
	GrapaError err;
	GrapaBlockDataHeader data;
	u64 returnSize;
...
GrapaError	GrapaCore::SetDataValue(u64 itemPtr, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::GetDataValue(u64 itemPtr, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::InsertDataValue(u64 itemPtr, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::DeleteDataValue(u64 itemPtr, u64 offset, u64 dataSize, u64 *returnSize)
{
	GrapaError err;
	GrapaBlockDataHeader data;
...
GrapaError GrapaCore::CopyDataValue(u64 toPtr, u64 toOffset, u64 fromPtr, u64 fromOffset, u64 moveSize, u64 *returnSize)
{
	GrapaError err;
...
GrapaError GrapaCore::MoveDataValue(u64 toPtr, u64 toOffset, u64 fromPtr, u64 fromOffset, u64 moveSize, u64 *returnSize)
{
	GrapaError err;
...
GrapaError	GrapaCore::GetDataParent(u64 dataPtr, u64& parentTree)
{
	GrapaError err = 0;
	GrapaBlockDataHeader data;
...
GrapaError	GrapaCore::Search(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree head;
	u8 found;
...
GrapaError GrapaCore::Insert(GrapaCursor& cursor)
{
	GrapaError err = 0;
	s8 result=1;
	GrapaBlockTree head;
...
GrapaError GrapaCore::Update(GrapaCursor& cursor)
{
	GrapaError err = 0;
...
GrapaError	GrapaCore::Delete(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError	GrapaCore::First(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError	GrapaCore::Last(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError	GrapaCore::Next(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree head;
...
GrapaError	GrapaCore::Prev(GrapaCursor& cursor)
{
	GrapaError err = 0;
	GrapaBlockTree head;
	GrapaBlockNodeHeader xNode;
...
GrapaError GrapaCore::CompareKey(s16 compareType, GrapaCursor& dataCursor, GrapaCursor& treeCursor, s8& result)
{
	result = GrapaCore::CompareKey(dataCursor.mKey,treeCursor.mKey);
	return(0);
}

GrapaError GrapaCore::DeleteKey(GrapaCursor& treeCursor)
{
	return(0);
}
...
bool GrapaCore::SearchNode(u64 rootNode, GrapaCursor& key, s8& pos, u64& child, GrapaBlockNodeLeaf& foundKey, s16 compareType)
{
	...
	while (h >= l)
	{
		...
		switch(key.mValueType)
		{
			...
			case SDATA_ITEM:
				...
				match = GrapaCore::CompareKey(foundKey.key, key.mKey);
				break;
			default:
				match = -1;
...
bool GrapaCore::SearchNodeFrag(u64 rootNode, GrapaCursor& key, s8& pos, u64& child, GrapaBlockNodeLeaf& foundKey, s16 compareType)
{
	GrapaBlockNodeHeader page,childPage;
	GrapaCursor leafCursor;
	s64 match;
	GrapaError err;
	s8 searchAdjust = (compareType==GrapaCore::INSERT_MODE)?0:-1; // Need the -1 to line up the search/delete to the next node
	...
	for (pos=0;pos<page.leafCount;pos++)
	{
		...
		if (match>=0) // found
		{
			if (compareType==GrapaCore::INSERT_MODE && match==0) // Insert after the found node
			{
				pos++;
...
GrapaError GrapaCore::InsInPage(GrapaBlockTree& head, GrapaCursor& treekey, u64 rootNode, GrapaBlockNodeHeader& page, GrapaBlockNodeLeaf& key, s8 pos)
{
	GrapaError err;
	s8 i;
	GrapaCursor cursor;
...
bool GrapaCore::SearchRc(u64 rootNode, GrapaCursor& key, GrapaBlockNodeLeaf& foundKey)
{
	GrapaError theErr;
	u64 child;
	GrapaBlockNodeHeader node;
...
GrapaError GrapaCore::SetKey(GrapaBlockTree& head, GrapaBlockNodeLeaf& leaf, GrapaCursor& cursor)
{
	GrapaError err;
	GrapaBlockDataHeader data;
	leaf.Init();
...
GrapaError GrapaCore::InsertRc(u64 headRef, GrapaBlockTree& head, u64 rootNode,
...
void GrapaCore::RotateParrentRight(u64 headRef, GrapaBlockTree& head, u64 middleOffset, GrapaBlockNodeHeader& middleTree)
{
...
void GrapaCore::RotateParrentLeft(u64 headRef, GrapaBlockTree& head, u64 middleOffset, GrapaBlockNodeHeader& middleTree)
{
...
GrapaError GrapaCore::UpdateChildInfo(u64 childBlock, u64 newBlock, s8 newIndex)
{
	GrapaError err = 0;
...
GrapaError GrapaCore::UpdateLeafInfo(GrapaBlockNodeLeaf* key, u64 newBlock, s8 newIndex)
{
	GrapaError err = 0;
...
GrapaError GrapaCore::MoveLeaf(u64 headRef, GrapaBlockTree& head, GrapaBlockNodeHeader& oldPage, u64 rootNode, s8 rootIndex, GrapaBlockNodeHeader& newPage, u64 newBlock, s8 newIndex)
{
	GrapaError err;
...
void GrapaCore::Split(u64 headRef, GrapaBlockTree& head, u64 rootNode, 
...
GrapaError GrapaCore::PurgeRc(u64 headRef, GrapaBlockTree& head, u64 rootNode, GrapaCursor& key, GrapaBlockNodeHeader& rootTree, s8& result)
{
...
GrapaError GrapaCore::AppendNode(u64 headRef, GrapaBlockTree& head, GrapaBlockNodeLeaf& promKey)
{
	GrapaError err;
...
void GrapaCore::RotateLeafRight(u64 headRef, GrapaBlockTree& head, s8 pos, u64 rootOffset, GrapaBlockNodeHeader& rootTree, 
...
void GrapaCore::RotateLeafLeft(u64 headRef, GrapaBlockTree& head, s8 pos, u64 rootOffset, GrapaBlockNodeHeader& rootTree, 
			u64 leftOffset, GrapaBlockNodeHeader& leftTree, u64 rightOffset, GrapaBlockNodeHeader& rightTree)
{
	s8 i;
	u64 tempChild;
...
void GrapaCore::MirgeLeft(u64 headRef, GrapaBlockTree& head, u64 rootOffset, s8 pos, GrapaBlockNodeHeader& rootTree, 
			u64 leftOffset, GrapaBlockNodeHeader& leftTree, u64 rightOffset, GrapaBlockNodeHeader& rightTree)
{
	GrapaBlockNodeLeaf tempKey;
	s8 i;
...
GrapaError GrapaCore::EmptyItem(u64 headRef, GrapaBlockTree& head, u64 pagePos)
{
	GrapaBlockNodeHeader node;
...
GrapaError GrapaCore::FindFirstX(u64 offset, GrapaCursor& cursor)
{
	GrapaError theErr;
	GrapaBlockNodeHeader node;
	GrapaBlockNodeLeaf result;
...
GrapaError GrapaCore::FindLastX(u64 offset, GrapaCursor& cursor)
{
	GrapaError err;
	GrapaBlockNodeHeader node;
	GrapaBlockNodeLeaf result;
...
u64 GrapaCore::FindFreePage(GrapaBlockPage& newPage, u64 maxBlockCount, u64 minBlockCount, u64* blocksReturned)
{
...
u64 GrapaCore::NewPage(u64 byteCount, bool clear)
{
	GrapaError err = 0;
	GrapaBlockPage hr;
	u64 offset;
...
GrapaError GrapaCore::PurgePage(u64 pagePos, u64 byteCount)
{
	GrapaError err;
...
GrapaError GrapaCore::GetWeight(GrapaCursor& treeCursor, u64& itemWeight)
{
	/*
	GrapaError err;
	GrapaBlockTree tree;
...
GrapaError GrapaCore::GainWeight(GrapaCursor& treeCursor, u64& treeWeight, u64 itemWeight, u64 childWeight)
{
	treeWeight += (itemWeight+childWeight);
	return(0);
}

GrapaError GrapaCore::LooseWeight(GrapaCursor& treeCursor, u64& treeWeight, u64 itemWeight, u64 childWeight)
{
	treeWeight -= (itemWeight+childWeight);
	return(0);
}

GrapaError GrapaCore::GetChildWeight(u64 childBlock, u64& childWeight)
{
	childWeight = 0;
	if (childBlock)
	{
...
GrapaError GrapaCore::RotateItemWeight(u64 headRef, GrapaBlockTree& head, u64 rootTree, GrapaBlockNodeLeaf& fromKey, GrapaBlockNodeHeader& fromTree, GrapaBlockNodeLeaf& toKey, GrapaBlockNodeHeader& toTree, u64 child)
{
	GrapaError err;
	GrapaCursor cursor;
...
GrapaError GrapaCore::LooseWeightCascading(GrapaCursor& cursor, u64 rootTree, GrapaBlockNodeHeader& oldPage, u64 child)
{
	GrapaError err;
	u64 itemWeight,childWeight;
	s8 parentIndex; 
...
GrapaError GrapaCore::GainWeightCascading(GrapaCursor& cursor, u64 rootTree, GrapaBlockNodeHeader& newPage, u64 child, u64 fistChild)
{
	GrapaError err;
...
GrapaError GrapaCore::GainChildWeightCascading(GrapaCursor& cursor, u64 rootTree, GrapaBlockNodeHeader& newPage, u64 child, u64 fistChild)
{
	GrapaError err;
...
GrapaError	GrapaCore::NewDataByte(GrapaBlockDataHeader& data, bool clear)
{
	data.dataStart = 0;
...
GrapaError	GrapaCore::DeleteDataByte(GrapaBlockDataHeader& data)
{
	return PurgePage(data.dataStart,data.dataSize);
}

GrapaError	GrapaCore::SetDataSizeByte(u64 itemPtr, GrapaBlockDataHeader& data, u64 dataSize, u64 dataLength)
{
	GrapaError err;
...
GrapaError	GrapaCore::GetDataSizeByte(GrapaBlockDataHeader& data, u64& growBlockSize, u64& dataSize, u64& dataLength)
{
...
GrapaError	GrapaCore::SetDataValueByte(u64 itemPtr, GrapaBlockDataHeader& data, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
...
GrapaError	GrapaCore::GetDataValueByte(GrapaBlockDataHeader& data, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
...
GrapaError	GrapaCore::InsertDataValueByte(u64 itemPtr, GrapaBlockDataHeader& data, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
...
GrapaError	GrapaCore::DeleteDataValueByte(u64 itemPtr, GrapaBlockDataHeader& data, u64 offset, u64 dataSize, u64 *returnSize)
{
	GrapaError err;
	u64 bytesWriten;
...
GrapaError GrapaCore::MoveDataValueByte(u64 toPtr, GrapaBlockDataHeader& toData, u64 toOffset, u64 fromPtr, GrapaBlockDataHeader& fromData, u64 fromOffset, u64 moveSize, u64 *returnSize)
{
...
GrapaError	GrapaCore::NewDataFrag(GrapaBlockDataHeader& data, bool clear)
{
...
GrapaError	GrapaCore::DeleteDataFrag(GrapaBlockDataHeader& data)
{
	return DeleteTree(data.dataStart);
}

GrapaError	GrapaCore::SetDataSizeFrag(u64 itemPtr, GrapaBlockDataHeader& data, u64 dataSize, u64 dataLength)
{
	GrapaError err;
	GrapaCursor cursor;
...
GrapaError	GrapaCore::GetDataSizeFrag(GrapaBlockDataHeader& data, u64& growBlockSize, u64& dataSize, u64& dataLength)
{
	growBlockSize = data.growBlockSize;
	dataSize = data.dataSize;
	dataLength = data.dataLength;
...
GrapaError	GrapaCore::SetDataValueFrag(u64 itemPtr, GrapaBlockDataHeader& data, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
	GrapaCursor cursor;
	GrapaBlockDataHeader frag;
...
GrapaError	GrapaCore::GetDataValueFrag(GrapaBlockDataHeader& data, u64 offset, u64 bufferSize, void *buffer, u64 *returnSize)
{
	GrapaError err;
	GrapaCursor cursor;
	GrapaBlockDataHeader frag;
...
GrapaError	GrapaCore::InsertDataValueFrag(u64 itemPtr, GrapaBlockDataHeader& data, u64 offset, u64 dataSize, void *dataBytes, u64 *returnSize)
{
	GrapaError err;
	GrapaCursor cursor;
...
GrapaError	GrapaCore::DeleteDataValueFrag(u64 itemPtr, GrapaBlockDataHeader& data, u64 offset, u64 dataSize, u64 *returnSize)
{
	GrapaError err;
	GrapaCursor cursor;
	u64 gsize;
...
GrapaError GrapaCore::MoveDataValueFrag(u64 toPtr, GrapaBlockDataHeader& toData, u64 toOffset, u64 fromPtr, GrapaBlockDataHeader& fromData, u64 fromOffset, u64 moveSize, u64 *returnSize)
{
	// Move fromData(fromOffset,moveSize) to toData(toOffset,moveSize)
	//    Create moveSize space at toData(toOffset)
	//    Copy data over
...
GrapaError GrapaCore::UpdateDataKeyFrag(GrapaCursor& cursor)
{
	GrapaError err;
	GrapaBlockDataHeader frag;
