...
def test_performance_debug():
    ...
    try:
        ...
        xy.eval('$global.col_table = {}.table("COL");')
        ...
        id15 = xy.eval('col_table.getfield("record15", "id").int();')
        name15 = xy.eval('col_table.getfield("record15", "name").str();')
        value15 = xy.eval('col_table.getfield("record15", "value").float();')
        ...
        xy.eval('$global.row_table = {}.table("ROW");')
        ...
        id8 = xy.eval('row_table.getfield("record8", "id").int();')
        name8 = xy.eval('row_table.getfield("record8", "name").str();')
        value8 = xy.eval('row_table.getfield("record8", "value").float();')
